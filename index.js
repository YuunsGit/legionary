...
client.on('ready', async () => {
    ...
    await client.guilds.cache.get('419963388941172737')?.commands.fetch().then(commands => {
    ...
    await (async () => {
        try {
            ...
            await rest.put(
                Routes.applicationGuildCommands('857603715028877323', '419963388941172737'),
                {body: commands}
            )
    ...
    fs.readdirSync('/root/legionary/schedules').forEach(file => {
