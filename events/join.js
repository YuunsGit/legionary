...
module.exports = {
    ...
    execute(member, client) {
        ...
        const embed = new MessageEmbed()
            .setAuthor('Üye Duyurusu:', client.guilds.cache.get('419963388941172737').iconURL())
            ...
            .setFooter('Artık Legion\'da tam ' + client.guilds.cache.get('419963388941172737').memberCount.toString() + ' üye bulunuyor.')
