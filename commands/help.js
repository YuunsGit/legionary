...
module.exports = {
    ...
    execute(interaction) {
        const embed = new EmbedBuilder({
            ...
            footer: {
                icon_url:
                    "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/star_2b50.png",
                text: "Tepki ve kayıt komutlarını kullanabilmek için yöneticilere başvurunuz.",
            },
        });
